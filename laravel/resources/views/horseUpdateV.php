                                            ...
                                            <form action="horseManageV" method="get" enctype="multipart/form-data">
                                                <table border="1">
                                                    ...
                                                    for($k=0 ; $k<=$num-1 ; $k++) {
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td align="center"><img src="/userUpload/<?php echo $value->horse_picture; ?>" width="150"
                                                                                    height="150"></td>
                                                            <td><input type="text" name="horseName" value="<?php echo $value->horse_name; ?>"></td>
                                                            <td><input type="text" name="horseAge" value="<?php echo $value->horse_age; ?>"></td>
                                                            <td><input type="text" name="horseIntroduce" value="<?php echo $value->horse_introduce; ?>"></td>
                                                            <input type="hidden" name="hId" value="<?php echo $value->h_id; ?>">
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
