...
<div class="wrap-main">
                                                ...
                                                <table border="1">
                                                    ...
                                                    for($k=0 ; $k<=$num-1 ; $k++) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center"><a href="memberUpdateV?id=<?php echo $value->id; ?>&memberName=<?php echo $value->name; ?>"><img src="icon/pencil.jpeg" width="30" height="30"></a></td>
                                                            <td align="center"><a href="memberManageV?action=delete&memberName=<?php echo $value->name; ?>&id=<?php echo $value->id; ?>"><img src="icon/x.jpeg" width="30" height="30"></a></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
    ...
    <?php if($action == 'update'){?>
        <script>
            function define() {
                alert("<?php echo $memberName;?> 資料已修改！");
            }
        </script>
        <?php
    } if($action == 'delete'){?>
        <script>
            function define() {
                alert("<?php echo $memberName;?> 資料已刪除！");
            }
        </script>
        <?php
    }if($action == 'insert'){?>
        <script>
            function define() {
                alert("<?php echo $memberName;?> 資料已新增！");
            }
        </script>
        <?php
    }
